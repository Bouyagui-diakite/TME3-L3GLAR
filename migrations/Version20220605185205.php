 ...
 */
final class Version20220605185205 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, date_depart DATE NOT NULL, heure DATE NOT NULL, nomcompagnie VARCHAR(255) NOT NULL, numero_vol VARCHAR(255) NOT NULL, nbre_bagage INT NOT NULL, nbre_accompagnants INT NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
